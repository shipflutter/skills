...
| App Distribution | `.claude/skills/appdist/` | Automated CI/CD deploy pipeline — iOS TestFlight, Android Firebase, and Google Play Store internal testing with Telegram notifications. | `scripts/deploy.sh` |
| Store Release | `.claude/skills/store-release/` | First-release checklist + fastlane workflow to submit a Flutter app to the App Store and Google Play (metadata + screenshots, first-submission gotchas, interactive guide page). | `templates/*/Fastfile` |
