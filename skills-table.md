...
| App Distribution | `.claude/skills/app-dist/` | Automated CI/CD deploy pipeline — iOS TestFlight, Android Firebase, and Google Play Store internal testing with Telegram notifications. | `scripts/deploy.sh` |
